...
### TODO: You have to change below considering your sub-block size
set core_width 900
set core_height 1100
...
# Place leaf instances in the core box
### TODO: You have to change below considering your sub-block size
placeInstance u_ibex_top 50 50 R0 -fixed
placeInstance u_IMEM/imem0 67.5 750 R0 -fixed
placeInstance u_DMEM/dmem0 700 750 R0 -fixed
placeInstance u_sram 260 700 R0 -fixed
...
saveNetlist -phys -excludeLeafCell -excludeCellInst "FILL1TS FILL2TS FILL4TS FILL8TS FILL16TS FILL32TS FILL64TS fill1" "$design_name.phy.v"
