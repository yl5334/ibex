...
#  Design:            ibex_system
#  Command:           saveNetlist ibex_system.nophy.v
###############################################################
*/
module sram_top (
	phi1, 
...
module ibex_system (
   ...
   ibex_top u_ibex_top (.test_en_i(test_en_i),
   ...
   sram_top u_sram (.phi1(test_en_i),
	.phi2(clk_i),
	.resetn(rst_ni),
	.comp_en(data_gnt_i),
	.ren(data_rvalid_i),
